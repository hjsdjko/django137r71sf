...
<div class="content" :style='{"minHeight":"100vh","padding":"0px 20px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230830/d58ecc944fb54dbfa18ecd2b64e92170.png) no-repeat center top / cover","display":"flex","fontSize":"16px"}'>
	...
	<div :style='{"margin":"0 20px 30px 0","alignItems":"center","color":"#fff","flexWrap":"wrap","display":"flex","width":"240px","fontSize":"inherit","justifyContent":"center"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 16px 0","borderRadius":"4px","background":"rgba(86,178,198,.8)","display":"flex","clipPath":"polygon(95% 0, 100% 50%, 95% 100%, 0% 100%, 0 50%, 0% 0)","width":"100%"}' v-if="isAuth('jiankangzixun','首页总数')">
			...
			<div :style='{"width":"calc(100% - 60px)","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{jiankangzixunCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>健康咨询总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 16px 0","borderRadius":"4px","background":"rgba(86,178,198,.6)","display":"flex","clipPath":"polygon(95% 0, 100% 50%, 95% 100%, 0% 100%, 0 50%, 0% 0)","width":"100%"}' v-if="isAuth('menzhenbingli','首页总数')">
			<div :style='{"width":"60px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-tongji5" :style='{"color":"inherit","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"calc(100% - 60px)","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{menzhenbingliCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>门诊病历总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 10px 16px 0","borderRadius":"4px","background":"rgba(86,178,198,.8)","display":"flex","clipPath":"polygon(95% 0, 100% 50%, 95% 100%, 0% 100%, 0 50%, 0% 0)","width":"100%"}' v-if="isAuth('jiankangjianyi','首页总数')">
			<div :style='{"width":"60px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-tongji5" :style='{"color":"inherit","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"calc(100% - 60px)","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{jiankangjianyiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>健康建议总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 4 -->
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div id="jiankangzixunChart1" class="echarts1" v-if="isAuth('jiankangzixun','首页统计')"></div>
		<div id="jiankangzixunChart2" class="echarts2" v-if="isAuth('jiankangzixun','首页统计')"></div>
		<div id="menzhenbingliChart1" class="echarts3" v-if="isAuth('menzhenbingli','首页统计')"></div>
		<div id="jiankangjianyiChart1" class="echarts4" v-if="isAuth('jiankangjianyi','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	data() {
		return {
            jiankangzixunCount: 0,
            menzhenbingliCount: 0,
            jiankangjianyiCount: 0,
	...
	mounted(){
		this.init();
		this.getjiankangzixunCount();
		this.jiankangzixunChat1();
		this.jiankangzixunChat2();
		this.getmenzhenbingliCount();
		this.menzhenbingliChat1();
		this.getjiankangjianyiCount();
		this.jiankangjianyiChat1();
	},
	methods:{
		// 词云
		...
		getjiankangzixunCount() {
			this.$http({
				url: `jiankangzixun/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.jiankangzixunCount = data.data
				}
			})
		},
		jiankangzixunChat1() {
        ...
        var jiankangzixunChart1 = echarts.init(document.getElementById("jiankangzixunChart1"),'cool');
        this.$http({
            url: "jiankangzixun/group/keshi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangzixunChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    jiankangzixunChart1.resize();
                };
            }
        });
      })
    ...
    jiankangzixunChat2() {
      this.$nextTick(()=>{
        ...
        var jiankangzixunChart2 = echarts.init(document.getElementById("jiankangzixunChart2"),'cool');
        this.$http({
            url: "jiankangzixun/group/yishengxingming",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangzixunChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    jiankangzixunChart2.resize();
                };
            }
        });
      })
		...
		getmenzhenbingliCount() {
			this.$http({
				url: `menzhenbingli/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.menzhenbingliCount = data.data
				}
			})
		},
		menzhenbingliChat1() {
        ...
        var menzhenbingliChart1 = echarts.init(document.getElementById("menzhenbingliChart1"),'cool');
        this.$http({
            url: `menzhenbingli/value/zhenduanshijian/zongjine/日`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].zhenduanshijian);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].zhenduanshijian
                    })
                }
                var option = {};
				let titleObj = this.line.title
				titleObj.text = '医疗费用统计'
                ...
                // 使用刚指定的配置项和数据显示图表。
                menzhenbingliChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    menzhenbingliChart1.resize();
                };
            }
        });
      })
		...
		getjiankangjianyiCount() {
			this.$http({
				url: `jiankangjianyi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.jiankangjianyiCount = data.data
				}
			})
		},
		jiankangjianyiChat1() {
        ...
        var jiankangjianyiChart1 = echarts.init(document.getElementById("jiankangjianyiChart1"),'helianthus');
        this.$http({
            url: "jiankangjianyi/group/jiankangdengji",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangjianyiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    jiankangjianyiChart1.resize();
                };
            }
        });
      })
