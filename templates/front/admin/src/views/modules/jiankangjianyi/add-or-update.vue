	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="健康评测" prop="jiankangpingce">
					<el-input v-model="ruleForm.jiankangpingce" placeholder="健康评测" clearable  :readonly="ro.jiankangpingce"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="健康评测" prop="jiankangpingce">
					<el-input v-model="ruleForm.jiankangpingce" placeholder="健康评测" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="健康等级" prop="jiankangdengji">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="健康等级" prop="jiankangdengji">
					<el-input v-model="ruleForm.jiankangdengji"
						placeholder="健康等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="评估时间" prop="pinggushijian">
					<el-date-picker
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.pinggushijian" label="评估时间" prop="pinggushijian">
					<el-input v-model="ruleForm.pinggushijian" placeholder="评估时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="评测依据" prop="pingceyiju">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.pingceyiju" label="评测依据" prop="pingceyiju">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.pingceyiju"></span>
                </el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="潜在风险" prop="qianzaifengxian">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.qianzaifengxian" label="潜在风险" prop="qianzaifengxian">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qianzaifengxian"></span>
                </el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="健康指导" prop="jiankangzhidao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.jiankangzhidao" label="健康指导" prop="jiankangzhidao">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiankangzhidao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.pingceyiju = this.ruleForm.pingceyiju.replace(reg,'../../../django137r71sf/upload');
        this.ruleForm.qianzaifengxian = this.ruleForm.qianzaifengxian.replace(reg,'../../../django137r71sf/upload');
        this.ruleForm.jiankangzhidao = this.ruleForm.jiankangzhidao.replace(reg,'../../../django137r71sf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
