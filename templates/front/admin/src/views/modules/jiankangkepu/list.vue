		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"fontSize":"inherit","display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">前期症状</label>
						<el-input v-model="searchForm.qianqizhengzhuang" placeholder="前期症状" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">文章详情</label>
						<el-input v-model="searchForm.wenzhangxiangqing" placeholder="文章详情" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.qianqizhengzhuang!='' && this.searchForm.qianqizhengzhuang!=undefined){
            params['qianqizhengzhuang'] = '%' + this.searchForm.qianqizhengzhuang + '%'
          }
           if(this.searchForm.wenzhangxiangqing!='' && this.searchForm.wenzhangxiangqing!=undefined){
            params['wenzhangxiangqing'] = '%' + this.searchForm.wenzhangxiangqing + '%'
          }
