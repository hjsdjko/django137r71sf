<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231018/e58ea030dd1e4c9ab9828a00aec6dcac.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"50px 20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0 0 0 50%","borderRadius":"10px","alignItems":"center","background":"#fff","flexDirection":"column","display":"flex","width":"50%","justifyContent":"center","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="false" :style='{"margin":"0 0 10px 0","color":"rgba(64, 158, 255, 1)","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","textShadow":"4px 4px 2px rgba(64, 158, 255, .5)"}'>基于Python的适老化(老年人)健康预警系统的设计与实现注册</p></div>
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="nianling">
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="yishenggonghao">
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="mima">
				<div v-if="true" :style='{"width":"100px","padding":"0 10px 0 0","lineHeight":"44px","fontSize":"14px","color":"#333","textAlign":"right"}' :class="changeRules('mima')?'required':''">密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="mima2">
				<div v-if="true" :style='{"width":"100px","padding":"0 10px 0 0","lineHeight":"44px","fontSize":"14px","color":"#333","textAlign":"right"}' :class="changeRules('mima')?'required':''">确认密码：</div>
				<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="yishengxingming">
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="touxiang">
				<div v-if="true" :style='{"width":"100px","padding":"0 10px 0 0","lineHeight":"44px","fontSize":"14px","color":"#333","textAlign":"right"}' :class="changeRules('touxiang')?'required':''">照片：</div>
                <file-upload
					tip="点击上传照片"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="keshi">
				<div v-if="true" :style='{"width":"100px","padding":"0 10px 0 0","lineHeight":"44px","fontSize":"14px","color":"#333","textAlign":"right"}' :class="changeRules('keshi')?'required':''">科室：</div>
                <el-select v-model="registerForm.keshi" placeholder="请选择科室" disabled>
                  <el-option
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="jibie">
				<div v-if="true" :style='{"width":"100px","padding":"0 10px 0 0","lineHeight":"44px","fontSize":"14px","color":"#333","textAlign":"right"}' :class="changeRules('jibie')?'required':''">级别：</div>
                <el-select v-model="registerForm.jibie" placeholder="请选择级别" disabled>
                  <el-option
                      v-for="(item,index) in yishengjibieOptions"
                      :key="index"
                      :label="item"
                      :value="item">
                  </el-option>
			...
			<el-form-item :style='{"width":"500px","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="lianxidianhua">
    ...
    created() {
		...
		if(this.$route.query.pageFlag=='register'){
		  ...
		  if ('yonghu' == this.tableName) {
			...
			this.yishengjibieOptions = "专家,主任医师,副主任医师,主治医师".split(',');
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
              ...
              if(`yonghu` == this.tableName && this.registerForm.yonghuzhanghao.length>13){
              ...
              if(`yonghu` == this.tableName && this.registerForm.mima.length>13){
              ...
              if(`yisheng` == this.tableName && this.registerForm.yishenggonghao.length<3){
                this.$message.error('医生工号长度不能小于3');
                return
              }
              if(`yisheng` == this.tableName && this.registerForm.yishenggonghao.length>13){
              ...
              if(`yisheng` == this.tableName && this.registerForm.mima.length<3){
                this.$message.error('密码长度不能小于3');
                return
              }
              if(`yisheng` == this.tableName && this.registerForm.mima.length>13){
                this.$message.error('密码长度不能大于13');
                return
              }
					if(`yisheng` == this.tableName && this.registerForm.lianxidianhua &&(!this.$validate.isMobile2(this.registerForm.lianxidianhua))){
