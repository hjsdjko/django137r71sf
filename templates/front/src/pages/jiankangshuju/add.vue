...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="身高(cm)" prop="shengao">
            <el-input v-model.number="ruleForm.shengao" 
                placeholder="身高(cm)" clearable :disabled=" false  ||ro.shengao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="体重(kg)" prop="tizhong">
			<el-input-number v-model="ruleForm.tizhong" placeholder="体重(kg)" :readonly="ro.tizhong"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="视力" prop="shili">
			<el-input-number v-model="ruleForm.shili" placeholder="视力" :readonly="ro.shili"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="心率(b/min)" prop="xinlv">
            <el-input v-model.number="ruleForm.xinlv" 
                placeholder="心率(b/min)" clearable :disabled=" false  ||ro.xinlv"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="血压(mmHg)" prop="xueya">
            <el-input v-model.number="ruleForm.xueya" 
                placeholder="血压(mmHg)" clearable :disabled=" false  ||ro.xueya"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="血糖(mmol/L)" prop="xuetang">
			<el-input-number v-model="ruleForm.xuetang" placeholder="血糖(mmol/L)" :readonly="ro.xuetang"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="血脂(mmol/L)" prop="xuezhi">
			<el-input-number v-model="ruleForm.xuezhi" placeholder="血脂(mmol/L)" :readonly="ro.xuezhi"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="更新时间" prop="gengxinshijian">
              <el-date-picker
