<template>
	<div :style='{"width":"1200px","margin":"10px auto","position":"relative","background":"#fff"}'>
	...
	<div :style='{"width":"100%","flexWrap":"wrap","display":"flex"}'>
		<div :style='{"width":"100%","margin":"10px auto","height":"auto","order":"0"}'>
			<div :style='{"margin":"0 auto","fontSize":"24px","lineHeight":"54px","color":"#000","textAlign":"left","background":"#fff"}'>健康资讯</div>
		</div>
