...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>诊断时间：</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
		  :style='{"border":"1px solid #769589","padding":"3px 10px","outline":"none","borderRadius":"8px","background":"#fff","width":"auto","justifyContent":"center"}'
          start-placeholder="诊断时间起始"
          end-placeholder="诊断时间结束"
	  ...
	  <el-button v-if="btnAuth('menzhenbingli','新增')" :style='{"cursor":"pointer","border":"1px solid #769589","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#769589","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","lineHeight":"35px","height":"35px"}' type="primary" @click="add('/index/menzhenbingliAdd')"><i v-if="true" :style='{"color":"#769589","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
		...
		<div class="list2 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
			<div :style='{"padding":"0","boxShadow":"0px 4px 10px 0px #769589","margin":"10px 1%","background":"#fff","display":"flex","width":"31%","fontSize":"0","position":"relative","height":"250px"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div class="item-info" :style='{"padding":"10px","overflow":"hidden","flex":"1","display":"inline-block","height":"290px"}'>
					<div :style='{"padding":"0 10px","lineHeight":"20px","fontSize":"14px","color":"#769589"}' class="name ">用户姓名:{{item.yonghuxingming}}</div>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.timeRange.length > 0) {
          searchWhere.zhenduanshijianstart = this.timeRange[0];
          searchWhere.zhenduanshijianend = this.timeRange[1];
        }
		if (this.sortType) searchWhere.sort = this.sortType
		if (this.sortOrder) searchWhere.order = this.sortOrder
        this.$http.get(`menzhenbingli/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/menzhenbingliDetail', query: params});
      },
